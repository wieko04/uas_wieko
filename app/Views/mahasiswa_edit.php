            ...
            <form class="form-horizontal" action="<?= base_url('mahasiswa/pro_edit') ?>" method="POST" enctype="multipart/form-data">
              ...
              <table class="table table-striped" style="font-weight: bold;">
                <tr>
                  ...
                  <td style="font-weight: bold;color: black;"><input type="number" name="nim" placeholder="NIM" class="form-control form-control-sm" required readonly value="<?= $mahasiswa->nim; ?>"></td>
                </tr>
                <tr>
                  <td style="font-weight: bold;color: black;">No. KTP</td>
                  <td style="font-weight: bold;color: black;">:</td>
                  <td style="font-weight: bold;color: black;"><input type="number" name="no_ktp" placeholder="No. KTP" class="form-control form-control-sm" required value="<?= $mahasiswa->no_ktp; ?>"></td>
                </tr>
                <tr>
                  <td style="font-weight: bold;color: black;">Nama Lengkap</td>
                  <td style="font-weight: bold;color: black;">:</td>
                  <td style="font-weight: bold;color: black;"><input type="text" name="nama_lengkap" placeholder="Nama Lengkap" class="form-control form-control-sm" required value="<?= $mahasiswa->nama_lengkap; ?>"></td>
                </tr>                
                <tr>
                  <td style="font-weight: bold;color: black;">Tempat Lahir</td>
                  <td style="font-weight: bold;color: black;">:</td>
                  <td style="font-weight: bold;color: black;"><input type="text" name="tempat_lahir" placeholder="Tempat Lahir" class="form-control form-control-sm" required value="<?= $mahasiswa->tempat_lahir; ?>"></td>
                </tr>                
                <tr>
                  <td style="font-weight: bold;color: black;">Tgl Lahir</td>
                  <td style="font-weight: bold;color: black;">:</td>
                  <td style="font-weight: bold;color: black;"><input type="date" name="tgl_lahir" placeholder="Tgl Lahir" class="form-control form-control-sm" required value="<?= $mahasiswa->tgl_lahir; ?>"></td>
                </tr> 
                <tr>
                  <td style="font-weight: bold;color: black;">Tgl Masuk</td>
                  <td style="font-weight: bold;color: black;">:</td>
                  <td style="font-weight: bold;color: black;"><input type="date" name="tgl_masuk" placeholder="Tgl Masuk" class="form-control form-control-sm" required value="<?= $mahasiswa->tgl_masuk; ?>"></td>
                </tr> 
                <tr>
                  ...
                  <td colspan="2"><select name="jenis_kelamin" class="form-control form-control-sm" data-placeholder="jenis_kelamin" required>
                      ...
                      <option value="Pria" <?php if($mahasiswa->jenis_kelamin == "Pria"){ echo "selected=selected";} ?>>Pria</option>
                      <option value="Wanita" <?php if($mahasiswa->jenis_kelamin == "Wanita"){ echo "selected=selected";} ?>>Wanita</option>
                    </select></td>
                </tr>              
                <tr>
                  <td style="font-weight: bold;color: black;">Alamat Lengkap</td>
                  <td style="font-weight: bold;color: black;">:</td>
                  <td style="font-weight: bold;color: black;"><input type="text" name="alamat_lengkap" placeholder="Alamat Lengkap" class="form-control form-control-sm" required  value="<?= $mahasiswa->alamat_lengkap; ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><select name="prodi" class="form-control form-control-sm" data-placeholder="Prodi" required>
                      ...
                      foreach ($opt_prodi as $row) {
                        if ($row->id == $mahasiswa->prodi) {
                          echo "<option value=" . $row->id . " selected=selected>" . $row->prodi . "</option>";
                        } else {
